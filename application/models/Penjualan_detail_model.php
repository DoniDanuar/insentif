...
class Penjualan_detail_model extends CI_Model {
    ...
    var $pK_table          = '';   
    var $v_table           = 'penjualan_detail';

    var $column_order = array(null, '','idpenjualan','idbarang','qty','hargajual','totalharga' );
    var $column_search = array('','idpenjualan','idbarang','qty','hargajual','totalharga');
