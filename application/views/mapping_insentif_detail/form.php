                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">idbaranginsentif</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idbaranginsentif" id="idbaranginsentif" placeholder="idbaranginsentif">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">bonus</label>
                          <div class="col-sm-9">
                      ...
                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">qtyterjual</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="qtyterjual" id="qtyterjual" placeholder="qtyterjual">
                          </div>
                      </div>
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success : function(result){
              ...
              $("#idbaranginsentif").val(result.idbaranginsentif);
              $("#bonus").val(result.bonus);
              $("#qtyterjual").val(result.qtyterjual);
    ...
    $('#form').bootstrapValidator({
      ...
      fields: {
        ...
        idbaranginsentif: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>idbaranginsentif tidak boleh kosong</span>"
            },
          }
        },        
        bonus: {
        ...
        qtyterjual: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>qtyterjual tidak boleh kosong</span>"
            },
          }
        },
      }
