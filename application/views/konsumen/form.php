                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                          <label for="staticEmail" class="col-sm-3 col-form-label">ID. Konsumen</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idkonsumen" id="idkonsumen" placeholder="Kode Otomatis Generate" readonly="">
                          </div>
                      </div>
                      ...
                      <div class="form-group row required">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="namakonsumen" id="namakonsumen" placeholder="Nama Lengkap">
                          </div>
                      </div>
    ...
    $('#form').bootstrapValidator({
      ...
      fields: {
        ...
        namakonsumen: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>namakonsumen tidak boleh kosong</span>"
            },
          }
        },
        notelp: {
