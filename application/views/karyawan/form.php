                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                          <label for="staticEmail" class="col-sm-3 col-form-label">ID. Karyawan</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idkaryawan" id="idkaryawan" placeholder="Kode Otomatis Generate" readonly="">
                          </div>
                      </div>
                      ...
                      <div class="form-group row required">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" name="namakaryawan" id="namakaryawan" placeholder="Nama Lengkap">
                          </div>
                          <div class="col-sm-3">
                      ...
                      <div class="form-group row required">
                          ...
                          <div class="col-sm-3">
                            <input type="text" class="form-control tanggal" name="tgllahir" id="tgllahir" placeholder="Tgl. Lahir">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">Kontak</label>
                          <div class="col-sm-5">
                            <input type="email" class="form-control" name="email" id="email" placeholder="E-mail">
                          </div>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" name="notelp" id="notelp" placeholder="No. Telp" onkeypress="return AllowOnlyNumbers(event);" minlength="11" maxlength="13">
                          </div>
                      </div>
                      ...
                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">Login</label>
                          <div class="col-sm-5">
...
$(document).ready(function(){
    ...
    $('.tanggal').mask('00-00-0000', {placeholder:"00-00-0000"});
    ...
    $('#form').bootstrapValidator({
      ...
      fields: {
        ...
        namakaryawan: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>namakaryawan tidak boleh kosong</span>"
            },
          }
        },
        jk: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>jk tidak boleh kosong</span>"
            },
          }
        },
        tempatlahir: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>tempatlahir tidak boleh kosong</span>"
            },
          }
        },
        tgllahir: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>tgllahir tidak boleh kosong</span>"
            },
          }
        },
        notelp: {
        ...
        jabatan: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>jabatan tidak boleh kosong</span>"
            },
          }
        },
        username: {
