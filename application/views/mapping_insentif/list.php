                    ...
                    <table class="table table-striped" id="table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 10%; text-align: center;">idmapping</th>
                                <th style="text-align: center;">tglmapping</th>
                                <th style="text-align: center;">idkaryawan</th>
                                <th style="text-align: center;">idinsentif</th>
                                <th style="text-align: center;">besarbonus</th>
                                <th style="text-align: center;">tagerterjual</th>
