                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                          <label for="staticEmail" class="col-sm-3 col-form-label">idmapping</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idmapping" id="idmapping" placeholder="Kode Otomatis Generate" readonly="">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">tglmapping</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="tglmapping" id="tglmapping" placeholder="tglmapping">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">idkaryawan</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idkaryawan" id="idkaryawan" placeholder="idkaryawan">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">idinsentif</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="idinsentif" id="idinsentif" placeholder="idinsentif">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">besarbonus</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="besarbonus" id="besarbonus" placeholder="besarbonus">
                          </div>
                      </div>

                      <div class="form-group row required">
                          <label for="inputPassword" class="col-sm-3 col-form-label">tagerterjual</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="tagerterjual" id="tagerterjual" placeholder="tagerterjual">
                          </div>
                      </div>
    ...
    $('#form').bootstrapValidator({
      ...
      fields: {
        ...
        tglmapping: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>tglmapping tidak boleh kosong</span>"
            },
          }
        },        
        idkaryawan: {
        ...
        idinsentif: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>idinsentif tidak boleh kosong</span>"
            },
          }
        },        
        besarbonus: {
        ...
        tagerterjual: {
          validators:{
            notEmpty: {
                message: "<span style='color:red;'>tagerterjual tidak boleh kosong</span>"
            },
          }
        },
      }
